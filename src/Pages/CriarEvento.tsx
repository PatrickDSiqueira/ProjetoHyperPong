...
export default function CriarEvento() {
    ...
    return <>
        ...
        <form action="http://localhost:4000/api/admin/eventos" method="post">
                    ...
                    <div className={showNewCat?"":"hidden"}>
                        <input type="text" value={nomeCat} onChange={(e)=>setNomeCat(e.target.value)} placeholder="Nome da Categoria" />
                        <input type="number" value={numCat} onChange={(e)=>setNumCat(parseInt(e.target.value))} placeholder="Número de Participantes" />
                    ...
                    <button onClick={seeNewCat} type="button" className={!showNewCat?"":"hidden"}>Criar Categorias</button>
